...
<body class="bg-brand-bg text-brand-text font-sans antialiased min-h-screen flex flex-col items-center justify-between p-4">
        ...
        <div class="bg-brand-surface border border-brand-border rounded-xl">
            <div class="p-4 sm:p-7">
                <div class="text-center">
                    <h2 class="block text-2xl font-bold text-gray-800 dark:text-white">Welcome Back</h2>
    ...
    <?php echo csrf_field(); ?>
                        <div class="grid gap-y-4">
                            <!-- Form Group -->
                            <div>
                                <label for="username" class="block text-sm mb-2 dark:text-white">Username or Email</label>
                                <div class="relative">
                    ...
                    <div class="mt-6 text-center">
                        <p class="text-sm text-gray-600 dark:text-neutral-400">
                            ...
                            <a class="text-brand-primary decoration-2 hover:underline font-medium" href="register">
                                Create one here
                            </a>
                        </p>
                    </div>

...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
    ...
    <div class="space-y-6">
        <!-- Balance Widget -->
        <div class="glass-card rounded-2xl p-6 border border-brand-border/60 text-center relative overflow-hidden">
            <!-- Glow effect -->
        ...
        <div class="bg-brand-surface/40 border border-brand-border rounded-2xl p-6">
            ...
            <div class="p-3.5 bg-brand-bg/50 border border-brand-border rounded-xl flex items-center space-x-3">
                ...
                <div class="truncate">
                    ...
                    <a href="mailto:admin@example.com" class="text-xs font-bold text-brand-secondary hover:underline truncate block">admin@example.com</a>
                </div>
            </div>
        </div>
    </div>
